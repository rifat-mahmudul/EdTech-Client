...
const PrivacyPolicy = () => {
    ...
    const allInfo = [
...

        {
            ...
            desc : "We may update this policy as needed. Continued use of our platform means you accept these terms. For any queries, contact support@virtualacademybd.com or whatsapp(01865467486) Or don't give ther the contract number."
        },
    ]
